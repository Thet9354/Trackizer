...
struct CardsView: View {
    ...
    @State var cardArr: [CreditCardModel] = [
        CreditCardModel(name: "Thet Pine", number: "**** **** **** 2789", month_year: "08/27"),
        CreditCardModel(name: "Thet Pine", number: "**** **** **** 2789", month_year: "07/27"),
        CreditCardModel(name: "Thet Pine", number: "**** **** **** 2789", month_year: "01/27"),
        CreditCardModel(name: "Thet Pine", number: "**** **** **** 2789", month_year: "03/28"),
        CreditCardModel(name: "Thet Pine", number: "**** **** **** 2789", month_year: "08/28")
    ]
                    ...
                    CardStack(cardArr) { cObj in
                        ...
                        ZStack{
                            ...
                            VStack(spacing: 8){
                                ...
                                Text("Virtual Card")
                                    .font(.customfont(.semibold, fontSized: 16))
