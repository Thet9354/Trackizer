...
// Enum representing custom font styles for the Inter font family
enum Inter: String {
...
// Extension on Font to provide a convenient method for using custom fonts
extension Font {
    
    // Creates custom font with specificed Inter style and size
    // Parameter: font and fontsize
    static func customfont(_ font: Inter, fontSized: CGFloat) -> Font {
        custom(font.rawValue, size: fontSized)
    }
}

    // Extensuon on CGFloat to provide screen-related properties and method
extension CGFloat {
...
// Extension on COlor to provie custom color option
extension Color {
